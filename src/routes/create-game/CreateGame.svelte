...
<Router {routes} prefix="/create-game" on:routeEvent={updateCurrentStep} />
...
<div class="container create-game">
  <div class="create-game__wrapper">
    ...
    <div class="create-game__mode-selection">
      <a href="/create-game/teams" use:link class="btn btn-primary">301</a>

      <span>Or</span>

      <a href="/create-game/teams" use:link class="btn btn-primary">501</a>
    </div>
